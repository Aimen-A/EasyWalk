...
if($user_ip === '::1') //FOR HEADQUATER
{   
    include('checkBranch.php');
}


elseif($user_ip === '192.168.43.21') //FOR LAHORE (SERVER2)
{   
    if(isset($_POST['replicateInsert'])){
        include("../inventoryAsyncho/server2asyncho.php");
...
elseif($user_ip === '192.168.43.94') //FOR FAISALABAD SERVER3
{
            
    if(isset($_POST['replicateInsert'])){
        include("../inventoryAsyncho/server3asyncho.php");
