...
<body>
    ...
    <form action='search.php' method='POST'> 
        ...
        <?php
            ...
            if($user_ip === '::1')//FOR HQ (selecting which branch's data to search)
            {
                echo"
                <tr>
                <td>Branch</td>
        ...
        ?>
            ...
            <tr>
                <td><button type="submit" name='inventoringSearch'class="button">Search</button></td>
            </tr>
        </table>
    </form>
